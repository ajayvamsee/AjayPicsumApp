            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    try {
                        ...
                        String authorName = responseObj.getString("author");

                        String authorImageURL = responseObj.getString("post_url");
                        courseModalArrayList.add(new CourseModal(authorName, authorImageURL));
                        buildRecyclerView();
